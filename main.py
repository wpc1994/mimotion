...
min_dict = {time_list[0]: 90000, time_list[1]: 150000, time_list[2]: 250000, time_list[3]: 300000, time_list[4]: 400000, time_list[5]: 500000, time_list[6]: 600000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 99999, time_list[1]: 159999, time_list[2]: 259999, time_list[3]: 309999, time_list[4]: 409999, time_list[5]: 509999, time_list[6]: 609999}
# 设置结束
